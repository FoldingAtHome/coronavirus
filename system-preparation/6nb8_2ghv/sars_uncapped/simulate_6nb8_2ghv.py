...
pdb_filename = 'input/6nb8_2ghv_complex_fixed.pdb'
...
# Write initial model
print('Writing initial solvated system to %s' % output_prefix + solvated_pdb_filename)
...
print('Serializing integrator to %s' % output_prefix + integrator_xml_filename)
